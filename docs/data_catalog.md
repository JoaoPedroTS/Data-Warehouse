...
## Visão Geral
A Camada Gold é a representação dos dados em nível de negócio, estruturada para suportar casos de uso analíticos e de relatórios. Ela consiste em **tabelas de dimensão** e **tabelas de fatos** para métricas específicas de negócio.
...
| category_id            | NVARCHAR(50)  | Identificador único da categoria do produto, vinculando-o à sua classificação de alto nível.               |
...
| product_key      | INT           | Chave substituta que relaciona o pedido à tabela de dimensão de produtos.                         |
| customer_key     | INT           | Chave substituta que relaciona o pedido à tabela de dimensão de clientes.                         |
